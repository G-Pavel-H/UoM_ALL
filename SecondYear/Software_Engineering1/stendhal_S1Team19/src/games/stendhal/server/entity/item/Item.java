...
public class Item extends PassiveEntity implements TurnListener, EquipListener,
	...
	private LinkedList<String> disguised_to;
	...
	public static void generateRPClass() {
		...
		// for disguises
		entity.addAttribute("disguise", Type.STRING, Definition.HIDDEN);
		entity.addAttribute("full_set", Type.INT, Definition.HIDDEN);
		entity.addAttribute("disguise_id", Type.INT, Definition.HIDDEN);
	}
...
//			this.add("deterioration", 1);
	...
	/**
	 * Set the disguise data of this item.
	 *
	 * @param disguisedTo list of entities to be disguised to
	 */
	public void setDisguisedTo(LinkedList<String> disguisedTo) {
		this.disguised_to = disguisedTo;
	}

	public LinkedList<String> getDisguisedTo() {
		return this.disguised_to;
	}
