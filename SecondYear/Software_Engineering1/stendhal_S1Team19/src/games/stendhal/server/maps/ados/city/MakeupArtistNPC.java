	...
	public void buildFidorea(final StendhalRPZone zone, int x, int y) {
		final SpeakerNPC npc = new SpeakerNPC("Fidorea") {
			...
			protected void createDialog() {
				...
				new OutfitChangerAdder().addOutfitChanger(this, behaviour, "buy",true,true);
			}

			private String getHelpDescription() {
				String helpTemplate = "I sell masks, would you like to see what I #offer. If you don't like your mask, you can #return and I will remove it, or you can just wait %s, until it wears off.";
