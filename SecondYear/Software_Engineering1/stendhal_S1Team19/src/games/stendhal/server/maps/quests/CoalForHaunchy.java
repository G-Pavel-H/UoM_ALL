...
public class CoalForHaunchy extends AbstractQuest {
	...
	private void bringCoalStep() {
		...
		//Player has 25 coal and not enough charcoal (Uses coal)
		npc.add(
				ConversationStates.ATTENDING, triggers,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, "start"), new AndCondition(new PlayerHasItemWithHimCondition("coal",25),new NotCondition(new PlayerHasItemWithHimCondition("charcoal",25)) )),
				ConversationStates.ATTENDING,
				null,
				new MultipleActions(
		...
		//Player has 25 charcoal and not enough coal (Uses charcoal)
		npc.add(
				ConversationStates.ATTENDING, triggers,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, "start"), new AndCondition(new PlayerHasItemWithHimCondition("charcoal",25),new NotCondition(new PlayerHasItemWithHimCondition("coal",25)) )),
				ConversationStates.ATTENDING,
				null,
				new MultipleActions(
		...
		//Player has enough of both coal and charcoal (defaults to use coal)
		npc.add(
				ConversationStates.ATTENDING, triggers,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, "start"), new AndCondition(new PlayerHasItemWithHimCondition("charcoal",25),new PlayerHasItemWithHimCondition("coal",25))),
				ConversationStates.ATTENDING,
				null,
				new MultipleActions(
						new DropItemAction("coal",25),
