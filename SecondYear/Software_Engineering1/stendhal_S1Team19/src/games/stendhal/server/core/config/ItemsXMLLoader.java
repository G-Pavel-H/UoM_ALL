...
public final class ItemsXMLLoader extends DefaultHandler {
	...
	/* Entities that can't see you when wearing this item */
	...
	public void startElement(final String namespaceURI, final String lName, final String qName,
		...
		if (qName.equals("item")) {
			...
			implementation = null;
			useBehavior = null;
			disguised_to = new LinkedList<String>();
		...
		} else if (qName.equals("disguised_to")) {
			disguised_to.add(attrs.getValue("entity"));
	...
	public void endElement(final String namespaceURI, final String sName, final String qName) {
		if (qName.equals("item")) {
			...
			item.setValue(value);
			item.setDisguisedTo(disguised_to);
			if (damageType != null) {
