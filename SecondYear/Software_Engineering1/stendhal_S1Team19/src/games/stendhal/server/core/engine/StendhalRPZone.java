...
public class StendhalRPZone extends MarauroaRPZone {
	...
	private final List<ItemDropListener> itemDropListeners;
	...
	public StendhalRPZone(final String name) {
		...
		itemDropListeners = new LinkedList<ItemDropListener>();
	...
	public boolean checkZone(final Player player, final RPAction action, final Entity entity){
		if (entity instanceof Item) {
			final Item item = (Item) entity;
			for (final ItemDropListener l : itemDropListeners) {
				if (!l.onDrop(item, this, action, player)){
					return false;
				}
			}
		}
	...
	public void addItemDropListener(final ItemDropListener listener) {
		itemDropListeners.add(listener);
	}

	public void removeItemDropListener(final ItemDropListener listener) {
		itemDropListeners.remove(listener);
	}
