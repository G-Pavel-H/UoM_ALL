...
public class FruitsForCoraliaTest extends ZonePlayerAndNPCTestImpl {
	...
	public void testQuest() {
		...
		assertEquals("Wonderful, what fresh delights have you brought? If you have brought them all, you can give me #everything!", getReply(npc));
	...
	@Test
	public void testIfEverythingIsAccepted() {
	    // Getting Coralia NPC, extracting FSM engine.
		npc = SingletonRepository.getNPCList().get("Coralia");
        en = npc.getEngine();
        ...
        // Equip required items to complete quest.
        // -----------------------------------------------
        PlayerTestHelper.equipWithStackableItem(player, "apple", 4);
        PlayerTestHelper.equipWithStackableItem(player, "banana", 5);
        PlayerTestHelper.equipWithStackableItem(player, "cherry", 9);
        ...
        // Before completing the quest, store current XP & Karma for future verification for quest completion.
		final int xp = player.getXP();
        final double karma = player.getKarma();
        // -----------------------------------------------
